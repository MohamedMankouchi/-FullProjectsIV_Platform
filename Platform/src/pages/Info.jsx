    ...
    <div className="infowrapper">
      ...
      <div className="info3">
        ...
        <p>
          ...
          gooien wij onze deuren open tot 15u, en jij bent uitgenodigd! Kom eens
          proeven van het leven als een student Multimedia & Creatieve
      ...
      <div className="info4">
        ...
        <p>
          ...
          projecten van afstuderende studenten in alle vier categorieën: Web &
          App, Smart Technology, Motion en Extended Reality. Volg de wegwijzers
          richting de parking van campus Kaai. Geraak je niet op de campus, maar
          wil je toch de eindwerken bekijken? Dan hebben we goed nieuws, want
          alle eindwerken zijn ook online te bekijken in onze showroom!
        </p>
        <h2>WANNEER?</h2>
        <p>Vrijdag 23 juni. Zaterdag 25 juni van 10u tot 13u.</p>
        <h2>WAAR?</h2>
        <p>
      ...
      <div className="any-questions">
        ...
        <ul>
          ...
          <li>
            Are there any hands-on activities or workshops at the final show?
          </li>
